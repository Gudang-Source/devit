...
<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<?php echo form_open_multipart('penyakit/form_save', 'class="form-horizontal"')?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<?php
										echo form_input(array('name'=>'penyakit', 'class'=>'form-control', 'value'=>set_value('penyakit')));
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<?php
										echo form_textarea(array('name'=>'deskripsi', 'rows'=>'2', 'class'=>'form-control', 'value'=>set_value('deskripsi')));
	...
	<div class="col-lg-6">
		<div class="img-thumbnail">		
			<img src="<?php echo base_url('userfiles/no_image.png');?>">
		</div>
	</div>
</div>
