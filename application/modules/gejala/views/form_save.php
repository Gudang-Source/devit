<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-edit fa-fw"></i> Form Diagnosa Penyakit</h3>
	</div>
</div>
<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<?php echo form_open('gejala/form_save', 'class="form-horizontal"')?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<?php
										echo form_textarea(array('name'=>'gejala', 'rows'=>'2', 'class'=>'form-control', 'value'=>set_value('gejala')));
